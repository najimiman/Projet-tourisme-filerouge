...
export default function Favorite() {
    const { APIDataFavorite} = React.useContext(ThemeContext)
    return (
                ...
                <div class="modal-content">
                    ...
                    <div class="container-fluid">
                        {APIDataFavorite.map((value) => {
                            ...
                            <p>{value.conseil}</p>
                            <p class="card-text"> <a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
